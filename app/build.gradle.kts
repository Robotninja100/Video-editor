...
dependencies {
    ...
    // De meetlat van de fase 0-poort — SSIM en de scherptemeting — staat zelf
    // ook onder test. Een scheve meetlat geeft een uitslag die nergens op slaat,
    // en dat is op een toestel juist niet te zien.
