...
import nl.artifation.videoeditor.model.ndcCenter
...
internal class CropPathEffect(
    ...
    override fun getMatrix(presentationTimeUs: Long): Matrix {
        ...
        return Matrix().apply {
            // Media3 rekent in NDC (-1..1, y omhoog), het model in 0..1 met y omlaag.
            // Die omrekening staat in `:core-model` en niet hier: hij is met vier
            // tests vastgelegd, en in deze module zou hij een emulator kosten.
            val (centerX, centerY) = rect.ndcCenter()
